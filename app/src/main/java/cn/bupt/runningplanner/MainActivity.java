...
public class MainActivity extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener, ViewPager.OnPageChangeListener {
    ...
    private void initBottomNavigationBar() {
        ...
        bottomNavigationBar.addItem(new BottomNavigationItem(R.drawable.ic_location_on_white_24dp, "跑步").setActiveColorResource(R.color.white))
                .addItem(new BottomNavigationItem(R.drawable.ic_favorite_white_24dp, "动态").setActiveColorResource(R.color.white))
                .addItem(new BottomNavigationItem(R.drawable.user, "我的").setActiveColorResource(R.color.white))
